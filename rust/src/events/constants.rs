...
pub enum RoomVersion {
    ...
    /// Room version 12
    V12,
    /// Room version org.matrix.msc1767.10
    OrgMatrixMsc1767_10, // "org.matrix.msc1767.10"
    /// Room version org.matrix.msc3757.10
    OrgMatrixMsc3757_10, // "org.matrix.msc3757.10"
    /// Room version org.matrix.msc3757.11
    OrgMatrixMsc3757_11, // "org.matrix.msc3757.11"
    /// Room version org.matrix.hydra.11
    OrgMatrixHydra11, // "org.matrix.hydra.11"
...
impl FromStr for RoomVersion {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            ...
            "11" => Ok(Self::V11),
            "12" => Ok(Self::V12),
            "org.matrix.msc1767.10" => Ok(Self::OrgMatrixMsc1767_10),
            "org.matrix.msc3757.10" => Ok(Self::OrgMatrixMsc3757_10),
            "org.matrix.msc3757.11" => Ok(Self::OrgMatrixMsc3757_11),
            "org.matrix.hydra.11" => Ok(Self::OrgMatrixHydra11),
